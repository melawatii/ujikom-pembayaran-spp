    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/entryTunggakan">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-bullet-list-67 text-warning text-sm opacity-10"></i>
                        </div>
                        <span class="nav-link-text ms-1">Tunggakan</span>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/entryHistory">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-align-left-2 text-info text-sm opacity-10"></i>
                        </div>
                        <span class="nav-link-text ms-1">Histori Pembayaran</span>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/tunggakanSiswa">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-sound-wave text-danger text-sm opacity-10"></i>
                        </div>
                        <span class="nav-link-text ms-1">Tunggakan</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/historySiswa">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-align-left-2 text-info text-sm opacity-10"></i>
                        </div>
                        <span class="nav-link-text ms-1">Histori Pembayaran</span>
