      ...
      <div class="page-header min-vh-100">
        <div class="container">
            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
              <div class="card card-plain">
                ...
                <div class="card-header pb-0 text-start">
                  ...
                  <p class="mb-0">Silahkan isi Username dan Password Anda!</p>
                </div>
                <div class="card-body">
          ...
          background-size: cover;">
                ...
                <h4 class="mt-5 text-white font-weight-bolder position-relative">"Aplikasi Pembayaran SPP"</h4>
                <p class="text-white position-relative">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur ullam sit nihil distinctio repudiandae autem error tenetur, eum impedit quae molestiae natus non odit atque inventore doloribus vel aliquam? Quis!</p>
              </div>
            </div>
          </div>
        </div>
